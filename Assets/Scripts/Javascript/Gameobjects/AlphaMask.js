...
function AlphaMask() {
	...
	this.Update = function() {
		...
		var positionX = 50, positionY = 150, sizeW = 360,sizeH = 270;
		
		ctx.drawImage(Images['mask'],positionX,positionY);

		this.pixels = ctx.getImageData(positionX,positionY,sizeW,sizeH);
/*		ctx.fillStyle = "rgb(25, 250, 230)";
